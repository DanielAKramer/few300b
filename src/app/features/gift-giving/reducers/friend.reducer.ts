...
const reducerFunction = createReducer(
  ...
  on(actions.setSelectFriend, (state, action) => ({ ...state, selectedFriend: action.id }))
);
...
export const { selectAll: selectFriendsArray, selectEntities: selectFriendsEntities } = adapter.getSelectors();
